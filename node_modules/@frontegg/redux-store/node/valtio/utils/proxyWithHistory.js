...
exports.proxyWithHistory_DEPRECATED = proxyWithHistory_DEPRECATED;
var _valtio = require("../valtio");
const isObject = x => typeof x === 'object' && x !== null;
let refSet;
const deepClone = obj => {
  if (!refSet) {
    refSet = (0, _valtio.unstable_buildProxyFunction)()[2];
  }
...
function proxyWithHistory_DEPRECATED(initialValue, skipSubscribe = false) {
  ...
  const proxyObject = (0, _valtio.proxy)({
    ...
    saveHistory: () => {
      ...
      proxyObject.history.snapshots.push((0, _valtio.snapshot)(proxyObject).value);
      ++proxyObject.history.index;
    },
    subscribe: () => (0, _valtio.subscribe)(proxyObject, ops => {
