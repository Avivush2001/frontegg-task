...
export interface ActivateAccountLocalization {
    ...
    activateAccount: {
        ...
        /**
         * Title to be displayed if activate account failed
         */
        failedTitle: string;
        /**
         * Description message to be displayed if activate account failed
         */
        ...
        /**
         * Activate account with code title
         */
        activateAccountOTCTitle: string;
        /**
         * Activate account with code message
         */
        activateAccountOTCMessage: string;
        /**
         * Or activate with text
         */
        orActivateWithSocialLogins: string;
    } & PrestepLocalization;
}
