...
export interface LoginLocalization {
    ...
    login: {
        ...
        backToLogin: string;
        /**
         * Button text to sign in with passkey
         */
        ...
        /**
         * Magic link resending button text
         */
        magicLinkResending: string;
        /**
        ...
        registerNewQuickLoginTitleWithSocial: string;
        ...
        skip: string;
        breachedPasswordBackToSignIn: string;
        breachedPasswordSuccessTitle: string;
        breachedPasswordSuccessSubtitle: string;
        breachedPasswordSuccessText: string;
        mfaEmailCodeTitle: string;
        mfaEmailCodeMessage: string;
        mfaEmailCodeContinueButton: string;
        mfaEmailCodeResendNewCode: string;
        mfaEmailCodeResending: string;
        /**
        ...
        /**
         * Pre enroll MFA with SMS submit button message
         */
        preEnrollMfaSMSSubmitButtonMessage: string;
        /**
         * MFA with SMS title
         */
        mfaSMSTitle: string;
