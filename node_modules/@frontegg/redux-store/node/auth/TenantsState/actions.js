...
var _default = (store, api, sharedActions) => {
  ...
  const resetTenantsState = () => {
    (0, _helpers.deepResetState)(store, ['auth', 'tenantsState'], _state.initialState);
  };
  ...
  const loadTenants = async payload => {
    ...
    try {
      ...
      const userTenantsResponseFunc = (0, _restApi.getCurrentUserTenantsFunction)(store.root.appName);
