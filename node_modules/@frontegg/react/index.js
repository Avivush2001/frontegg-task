...
var CMCComponent = React.memo(function (_a) {
    var themeOptions = _a.themeOptions, props = _a.props, localizations = _a.localizations, hostStyle = _a.hostStyle, renderComponent = _a.renderComponent;
    var ref = React__default.useRef(null);
    React__default.useLayoutEffect(function () {
        var app = js.AppHolder.getInstance('default');
        if (!ref.current) {
            return;
        }
        var rootRendered = {
        ...
        }).then(function (root) { return (rootRendered = root); });
    }, []);
    return React__default.createElement("div", { style: __assign({}, hostStyle), ref: ref });
}, function () { return true; });

var UsersTable = function (props) {
    return React__default.createElement(CMCComponent, __assign({ renderComponent: 'renderUsersTable' }, props));
};
var InviteUserDialog = function (props) {
    return React__default.createElement(CMCComponent, __assign({ renderComponent: 'renderInviteUserDialog' }, props));
};
var ChangePasswordForm = function (props) {
    return React__default.createElement(CMCComponent, __assign({ renderComponent: 'renderChangePasswordForm' }, props));
};
var ProfilePage = function (props) {
    return React__default.createElement(CMCComponent, __assign({ renderComponent: 'renderProfilePage' }, props));
};

var useUsersTable = function (id) {
    var app = js.AppHolder.getInstance('default');
    var _a = React.useState(reduxStore.createProxy({
        onSearch: function () { },
        searchQuery: '',
        searching: false,
    ...
    return reactHooks.useSnapshot(store);
};
var useInviteUserDialog = function (id) {
    var app = js.AppHolder.getInstance('default');
    var _a = React.useState(reduxStore.createProxy({
        dialogOpen: false,
        openDialog: function () { },
    ...
    React__default.useLayoutEffect(function () {
        app
            .getInviteUserDialogStore({ id: id })
            .then(function (store) {
            setStore(store);
        })
            .catch(function (err) {
...
exports.CMCComponent = CMCComponent;
