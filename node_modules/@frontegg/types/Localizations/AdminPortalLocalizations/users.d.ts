export interface UsersLocalization {
    ...
    users: {
        ...
        /**
         * Table row action for disabling user
         */
        disableUserAction: string;
        /**
         * Table row action for enabling user
         */
        enableUserAction: string;
        /**
    ...
    users_InviteUser: {
        ...
        bulkFormHelper: string;
        bulkDomainsError: string;
        selectRole: string;
        multipleRoles: string;
        uniqueEmailError: string;
        invitationSuccessfully: string;
        userAlreadyExistsPart1: string;
    ...
    /**
     * Enable user dialog strings
     */
    users_enableUserDialog: {
        cancelButton: string;
    ...
    /**
     * Disable user dialog strings
     */
    users_disableUserDialog: {
        cancelButton: string;
        proceedButton: string;
        dialogTitle: string;
        dialogDescription: string;
