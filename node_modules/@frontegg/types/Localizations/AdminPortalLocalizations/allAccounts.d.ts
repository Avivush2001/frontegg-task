export interface AllAccountsLocalization {
    ...
    singleAccountView: {
        ...
        subAccounts: string;
        /**
         * Have access to sub‒accounts text
    ...
    singleAccountView_usersTable: {
        ...
        /**
         * Resend invitation email button text
         * @default 'Resend invitation email'
         * */
        resendInvitationBtnText: string;
        /**
    ...
    singleAccountView_AddUsersDialog: {
        ...
        /**
         * Bulk input label without roles
         * @default 'Email'
         * */
        bulkInputLabelWithoutRoles: string;
        /**
         * Bulk input label with roles
         * @default 'Email & Role'
         * */
        bulkInputLabelWithRoles: string;
        /**
         * Bulk input helper text
         * @default 'You can invite up to 5 users at a time.'
         * */
        bulkInputHelperText: string;
        /**
         * Bulk input domains restriction error text
         * @default "Sorry, you can't invite users with this domain due to your organization's restrictions."",
         * */
        bulkInputDomainsRestrictionError: string;
        /**
         * Bulk input placeholder
         *  @default 'Type email address and press "Enter"''
         * */
        bulkInputPlaceholder: string;
        /**
         * Bulk input unique emails error text
         */
        bulkInputDuplicatedEmailsError: string;
    };
    /**
